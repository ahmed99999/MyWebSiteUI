...
class Movies extends Component {
    ...
    getPagedData = ( movies, sortColumn, currentGenre, currentGenre, pageSize ) => {
    ...
    render() {
        ...
        const { size, paginatedMovies } = this.getPagedData( movies, sortColumn, currentGenre, currentPage, pageSize );
