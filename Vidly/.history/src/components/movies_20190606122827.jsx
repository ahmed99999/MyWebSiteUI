...
class Movies extends Component {
    ...
    render() {
        ...
        const resetButton = <button className="btn btn-primary">Reset</button> ;
        ...
        return (
            <React.Fragment>
                ...
                <table className="table">
                    ...
                    <tbody>
                        {movies.map( (movie) => (
                            <Movie key={movie._id} movie={movie} onDelete ={ () => this.handleDelete(movie._id)} onIncrement ={()=>this.handelIncrement}/>
                        ))}
                    </tbody>
                </table>
            </React.Fragment>
